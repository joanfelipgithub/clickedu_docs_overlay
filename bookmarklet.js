...
(async function () {
  ...
  // --------- AMAGA LA PASSAREL·LA DE CLICKEDU ---------
  ...
  async function loadDocs(overlay, loadingMsg) {
    const SHEET_URL =
      "https://docs.google.com/spreadsheets/d/1iAF3p81G8DdByShDyfz4ShoweV80QWuoQ7wWSzZUORQ/export?format=csv&gid=0";
